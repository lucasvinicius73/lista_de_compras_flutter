...
class Task extends _Task with RealmEntity, RealmObjectBase, RealmObject {
  ...
  Task(
    ...
    RealmObjectBase.set(this, 'descripion', descripion);
  ...
  String get descripion =>
      RealmObjectBase.get<String>(this, 'descripion') as String;
  @override
  set descripion(String value) =>
      RealmObjectBase.set(this, 'descripion', value);
  ...
  static SchemaObject _initSchema() {
    ...
    return const SchemaObject(ObjectType.realmObject, Task, 'Task', [
      ...
      SchemaProperty('descripion', RealmPropertyType.string),
